package java_github_practice.okul;

import advanced_practice10.okul.Ogrenci;
import advanced_practice10.okul.Okul;
...
public class OkulMain {
 /*
    ...
    public static void main(String[] args) {
        ...
        advanced_practice10.okul.Okul okul = new Okul();
        ...
        for (int i = 1; i <= okul.getMaxOgrenciSayisi(); i++) {
            ...
            advanced_practice10.okul.Ogrenci ogrenci = new Ogrenci();
